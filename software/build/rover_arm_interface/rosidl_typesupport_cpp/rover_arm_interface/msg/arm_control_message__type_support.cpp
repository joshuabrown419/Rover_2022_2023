...
static const _ArmControlMessage_type_support_symbol_names_t _ArmControlMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rover_arm_interface, msg, ArmControlMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rover_arm_interface, msg, ArmControlMessage)),
  }
};
...
{
  return &::rover_arm_interface::msg::rosidl_typesupport_cpp::ArmControlMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rover_arm_interface, msg, ArmControlMessage)() {
  return get_message_type_support_handle<rover_arm_interface::msg::ArmControlMessage>();
}
