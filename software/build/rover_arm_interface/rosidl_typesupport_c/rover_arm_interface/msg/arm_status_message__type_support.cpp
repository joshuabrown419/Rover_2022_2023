...
static const _ArmStatusMessage_type_support_symbol_names_t _ArmStatusMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rover_arm_interface, msg, ArmStatusMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rover_arm_interface, msg, ArmStatusMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rover_arm_interface, msg, ArmStatusMessage)() {
  return &::rover_arm_interface::msg::rosidl_typesupport_c::ArmStatusMessage_message_type_support_handle;
}
